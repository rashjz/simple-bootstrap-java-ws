        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top navbar-custom">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="#page-top">Rashad Javadov</a>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="intro-text">
                            ...
                            <hr class="star-light">
                            <span class="skills">Web, Mobile & Software Developer</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="success" id="about">
            <div class="container">
                ...
                <div class="row">
                    Education : 
                    <p>
                        Baku State University (2007 / 2011)
                    ...
                    <div class="col-lg-3">
                        <p>
                            ...
                            WEB : JQuery, Ajax, Java Script, HTML, CSS
                            Linux  : Ubuntu, Cent OS, Oracle Linux
                        </p>
                    </div>
                    <div class="col-lg-3">
                        <p> 
        ...
        <footer class="text-center">
                    ...
                    <div class="row">
                        ...
                        <div class="footer-col col-md-4">
                            ...
                            <ul class="list-inline">
                                <li>
                                    <a href="https://www.facebook.com/app_scoped_user_id/10206703486889098/" class="btn-social btn-outline"><i class="fa fa-fw fa-facebook"></i></a>
                                </li>
                                <li>
                                    <a href="http://profiles.google.com/112122421818249085414" class="btn-social btn-outline"><i class="fa fa-fw fa-google-plus"></i></a>
                                </li>
                                <li>
                                    <a href="http://twitter.com/rashjz" class="btn-social btn-outline"><i class="fa fa-fw fa-twitter"></i></a>
                                </li>
                                <li>
            ...
            <div class="footer-below">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            Copyright &copy; Rashad Javadov 2016
                        </div>
                    </div>
                </div>
            </div>
